...
for Successive Halving. This algorithm has knowledge of $\mu_*$.
...
of Successive Halving and compare it to other anytime algorithms.
When an effectively unlimited budget is available, Successive Halving
...
run Successive Halving with budget $T=n\log_2 n$ and save the result
...
The class of experiments in Figure~\ref{appendix:fig:sh-num-arms} reports the average simple regret for Successive Halving using $n^*_T$ (the maximum number of arms s.t. $T \ge n^*_T\log_2 n^*_T$) in comparison to various
...
Successive Halving run with $n^*_T$ arms to that of various pure exploration baselines.
...
Finally, in Figure~\ref{appendix:fig:sh-anytime}, we compare Successive Halving  and Successive Halving Anytime to several other anytime algorithms.
...
%
%\begin{subfigure}{0.4\textwidth}
%	\includegraphics[width=\textwidth]{fixedbudget/figures/folder5/new_yorker.png}
%	\caption{New Yorker}
...
\begin{figure}
% \vspace{-2.5em}
\includegraphics[width=\textwidth]{fixedbudget/figures/reversed_individual_539_summary_LilUCB.png}
